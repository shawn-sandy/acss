...
cp -r /path/to/fpkit-consumer ~/.claude/skills/
...
```bash
ls ~/.claude/skills/fpkit-consumer/
...
```bash
# Validate a file
python ~/.claude/skills/fpkit-consumer/scripts/validate_css_vars.py styles/button.scss

# Validate a directory
python ~/.claude/skills/fpkit-consumer/scripts/validate_css_vars.py styles/

# From your project root
python ~/.claude/skills/fpkit-consumer/scripts/validate_css_vars.py .
```
...
cat ~/.claude/skills/fpkit-consumer/references/composition.md

# View CSS variable guide
cat ~/.claude/skills/fpkit-consumer/references/css-variables.md

# View accessibility guide
cat ~/.claude/skills/fpkit-consumer/references/accessibility.md

# View architecture guide
cat ~/.claude/skills/fpkit-consumer/references/architecture.md

# View testing guide
cat ~/.claude/skills/fpkit-consumer/references/testing.md

# View Storybook guide
cat ~/.claude/skills/fpkit-consumer/references/storybook.md
```
...
~/.claude/skills/fpkit-consumer/scripts/sync-docs.sh

# Check which docs need updating
~/.claude/skills/fpkit-consumer/scripts/sync-docs.sh --check

# Sync a specific guide
~/.claude/skills/fpkit-consumer/scripts/sync-docs.sh --guide testing.md
```
...
1. **Check installation path:**
   ```bash
   ls ~/.claude/skills/fpkit-consumer/SKILL.md
   ```
...
2. **Make script executable:**
   ```bash
   chmod +x ~/.claude/skills/fpkit-consumer/scripts/validate_css_vars.py
   ```

3. **Run with python3 explicitly:**
   ```bash
   python3 ~/.claude/skills/fpkit-consumer/scripts/validate_css_vars.py styles/
   ```
...
```bash
# List references
ls ~/.claude/skills/fpkit-consumer/references/
