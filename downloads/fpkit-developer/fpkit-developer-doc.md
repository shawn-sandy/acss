...
Use **fpkit-developer** when you need to:
...
**Check for scripts:**
```bash
ls ~/.claude/skills/fpkit-developer/scripts/
```
...
**Check for assets:**
```bash
ls ~/.claude/skills/fpkit-developer/assets/
```
...
**View SKILL.md:**
```bash
cat ~/.claude/skills/fpkit-developer/SKILL.md
```
...
**Example invocation:**
```
You: [Your task that relates to fpkit-developer]
```

For installation help, see `fpkit-developer-Download.md`.
