...
/**
 * Minimal component props shared by all icons. Intentionally inlined rather
 * than imported from `@fpkit/acss` so this package stays dependency-free.
 */
export interface IconBaseProps {
  /** Child elements (used by the internal Svg wrapper). */
  children?: ReactNode
  /** Inline style object applied to the root SVG. */
 ...
 * ```
 */
export interface IconProps extends Partial<IconBaseProps> {
  /** SVG fill color */
  fill?: string
