...
The fpkit navigation styling system provides flexible navigation components using
semantic `<nav>` elements or ARIA labels. Navigation supports horizontal and
vertical layouts, responsive behavior, and comprehensive keyboard accessibility.
...
- **W3C ARIA: Navigation Landmark** - https://www.w3.org/WAI/ARIA/apg/patterns/landmarks/
