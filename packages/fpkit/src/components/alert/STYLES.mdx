...
| ----------------------- | -------- | ----------------------------------------- |
| *(none)* or `"outlined"` | Outlined | Light background with colored border (default) |
...
```html
<div role="alert" data-alert="success" data-variant="filled" data-visible="true">
  <span class="alert-icon" aria-hidden="true">✓</span>
  <div class="alert-message">
...
- **Logical properties** (`margin-block-start`): Chrome 87+, Firefox 66+,
  Safari 14.1+
