...
export const Alpha: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Alpha variant with warning colors for early development features.',
      },
    },
  },
}
...
export const Stable: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Stable variant with success colors for production-ready releases.',
      },
    },
  },
}
...
export const Production: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Production variant with primary colors for live environment indicators.',
      },
    },
  },
}
...
const DynamicStatusComponent = () => {
  ...
  return (
    <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
      ...
      <button
        onClick={() => setStatus(status === 'Deploying' ? 'Deployed' : 'Deploying')}
...
export const InlineUsage: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Tags used inline within paragraph text for contextual labeling.',
      },
    },
  },
}
...
export const CustomStyling: Story = {
  render: () => (
    <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', alignItems: 'center' }}>
      <Tag styles={{ backgroundColor: '#ff6b6b', color: 'white', fontSize: '0.75rem' }}>
        Custom Red
      </Tag>
      <Tag
        variant="beta"
        styles={{ fontSize: '1rem', padding: '0.5rem 1rem', fontWeight: 'bold' }}
      >
        Large Beta
      </Tag>
      <Tag styles={{ backgroundColor: '#4ecdc4', color: 'white', borderRadius: '0.25rem' }}>
        Square Tag
      </Tag>
    </div>
  ),
  parameters: {
    docs: {
      description: {
        story: 'Tags with custom inline styles overriding default CSS custom properties.',
      },
    },
  },
}
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      ...
      <div>
        ...
        <div style={{ display: 'flex', gap: '0.5rem', marginTop: '0.5rem' }}>
          <Tag role="status" variant="production" aria-label="Server running status">
            Running
          </Tag>
          <Tag role="status" variant="beta" aria-label="Build in progress status">
            Building...
          </Tag>
        </div>
      </div>
