...
<input
  type="text"
  style="--input-bg: #f0f0f0; --input-border-color: blue"
/>
```
...
**Note:** The asterisk (*) is automatically appended to the placeholder text for
required fields.
...
```html
<form>
  <fieldset style="border: 1px solid gray; padding: 1rem; border-radius: 0.5rem">
...
<input type="text" style="--input-bg: white; --input-outline: thin solid gray" />
```
