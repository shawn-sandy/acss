...
Learn how to discover and customize CSS custom properties in @fpkit/acss components.

> **📖 Full Guide:** For comprehensive documentation, see [docs/guides/css-variables.md](https://github.com/shawn-sandy/acss/blob/main/packages/fpkit/docs/guides/css-variables.md)
...
- **📖 [Full CSS Variables Guide](https://github.com/shawn-sandy/acss/blob/main/packages/fpkit/docs/guides/css-variables.md)** - Comprehensive documentation
- **📘 [Composition Guide](https://github.com/shawn-sandy/acss/blob/main/packages/fpkit/docs/guides/composition.md)** - Building custom components
- **♿ [Accessibility Guide](https://github.com/shawn-sandy/acss/blob/main/packages/fpkit/docs/guides/accessibility.md)** - WCAG compliance

---

**Explore component stories** in this Storybook to see CSS variable customization examples in action!
