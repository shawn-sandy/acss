...
- **Utility Functions** - Clean separation of concerns ([card.utils.ts](packages/acss/src/components/cards/card.utils.ts#L1))
...
Run tests:
```bash
cd packages/acss && npm test card.test.tsx
```
