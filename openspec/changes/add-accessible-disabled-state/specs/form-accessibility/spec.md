...
The Form Accessibility capability provides reusable patterns, hooks, and utilities for implementing WCAG 2.1 Level AA compliant disabled states across form components. It ensures consistent keyboard accessibility, screen reader support, and visual feedback for disabled form elements throughout the @fpkit/acss component library.
